			...
			<div>
				...
				<div className="MainAlles">
					...
					<div className="MainAllgemeinDaten">
						<TextBox
							titel="Vorname"
							text={patientGesamt.allgemein.vorname}
							width={"300px"}
						/>
						<TextBox
							titel="Nachname"
							text={patientGesamt.allgemein.nachname}
							width={"300px"}
						/>
						<TextBox
							titel="Wohnort"
							text={
								patientGesamt.allgemein.addresse.plz +
								" " +
								patientGesamt.allgemein.addresse.ort
							}
							width={"300px"}
						/>
						...
						<TextBox
							titel="Telefon Mobil"
							text={patientGesamt.allgemein.nummern.mobil}
							width={"300px"}
						/>
						<TextBox
							titel="Telefon Privat"
							text={patientGesamt.allgemein.nummern.privat}
							width={"300px"}
						/>
						<TextBox
							titel="Telefon Arbeit"
							text={patientGesamt.allgemein.nummern.arbeit}
							width={"300px"}
						/>
					</div>
